        ...
        <div className="fixed bottom-24 right-4 sm:right-6 z-40 flex w-[calc(100vw-2rem)] max-w-md flex-col rounded-3xl border border-slate-200/80 dark:border-slate-800 bg-white/95 dark:bg-[#111827]/95 shadow-2xl overflow-hidden backdrop-blur-xl animate-fade-in-up">
          ...
          <div className="flex flex-col max-h-[min(70vh,460px)]">
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              <div className="p-2.5 rounded-xl bg-primary-50/70 dark:bg-primary-950/40 border border-primary-100 dark:border-primary-900/40 text-[12px] text-slate-600 dark:text-slate-400 flex items-center gap-2">
                <Sparkles className="w-4 h-4 text-primary-600 dark:text-primary-400 shrink-0" />
                <span>Ask <strong>V</strong> about career roadmaps, skill milestones, or site navigation.</span>
              </div>
                  ...
                  <div
                    className={`max-w-[85%] rounded-2xl px-4 py-2.5 text-sm ${
                      msg.role === "user"
                        ...
                        : "bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-200 shadow-sm border border-slate-200/60 dark:border-slate-700/60"
                    }`}
                  >
                    {msg.role === "assistant" ? (
                ...
                <div className="flex flex-wrap gap-1.5">
                  {suggestedQuestions.map((q) => (
                    <button
                      ...
                      onClick={() => send(q)}
                      disabled={loading}
                      className="text-left text-xs px-3 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 hover:bg-primary-50 dark:hover:bg-primary-950/60 hover:text-primary-600 dark:hover:text-primary-400 transition btn-3d"
                    >
                      {q}
                    </button>
                  ))}
